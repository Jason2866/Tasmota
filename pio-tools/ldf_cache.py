...
This script ensures idedata.json is always generated by making it a dependency
of the firmware build, then reads and caches LDF results as a Python dict for
robust subsequent builds.
