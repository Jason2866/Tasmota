...
This script ensures idedata.json is always generated by adding the 'idedata'
target to the build, then reads and caches LDF results for fast subsequent builds.
...
# --- Ensure idedata.json is always generated by adding the 'idedata' target ---
...
class LDFCacheOptimizer:
    ...
    def get_project_hash_with_details(self):
        ...
        Returns:
            dict: Hash details
        """
        # For brevity, use a simple hash of platformio.ini and src files
        hash_data = []
        if os.path.exists(self.platformio_ini):
