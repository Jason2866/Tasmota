...
def esp32_fetch_safemode_bin(chip):
    safemode_fw_url = "https://github.com/Jason2866/Tasmota-specials/raw/firmware/firmware/tasmota32/other/tasmota" + chip[3:] + "-minicustom.bin"
    safemode_fw_name = safemode_dir + "/tasmota" + chip[3:] + "-minicustom.bin"
